...
def initialMenu(top):
    studentCommand = tk.Button(top, text="Student", command=lambda: studentMenu(top), height=2, width=20)
    teacherCommand = tk.Button(top, text="Professor", command=lambda: teachMenu(), height=2, width=20)
